...
- インストール可能な未署名 Windows x86_64 Alpha を初めて提供します。リリースの添付ファイルは、言語タグのない NSIS setup と MSI のインストーラーだけです。
- setup はシステム全体にインストールするため、開始時に管理者権限を要求します。MSI もシステム全体にインストールします。
