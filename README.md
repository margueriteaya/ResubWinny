...
说回 ResubWinny 这个名字，原本的 Winny，是在 2002 年发布的 P2P 文件共享软件，该软件的广泛使用伴随着著作权内容与不当内容的传播，被视作社会问题，但软件作者却因为用户的行为遭到检控。2023 年，该事件同名电影上映，次年在上海国际电影节展映的片名叫做「开发者有罪」。

Resub 代表对字幕的再加工，而 Winny 的是为了向这个名字的发明者金子勇 a.k.a. 47氏致敬，也是为了遵循一个基本常识：
