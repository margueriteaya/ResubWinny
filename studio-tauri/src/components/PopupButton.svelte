...
<div class:open class="popup-button" bind:this={root}>
  ...
  {#if open}
    <div class="popup-menu" role="listbox" aria-label={label} tabindex="-1" onkeydown={menuKeydown} transition:liquidPopover>
