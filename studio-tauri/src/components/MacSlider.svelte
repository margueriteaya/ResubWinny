...
<style>
  ...
  @media(hover:hover) and (pointer:fine){.mac-slider:hover .slider-thumb{box-shadow:0 1px 4px rgba(0,0,0,.26),inset 0 1px rgba(255,255,255,.9),inset 0 -1px var(--rw-glass-dark-edge)}}
