...
<section class="onboarding-page" class:motion-paused={motionPaused} aria-labelledby="onboarding-title">
  ...
  <div class="onboarding-content">
    ...
    <footer class="sequence-actions">
      ...
      <button class="complete liquid-control" type="button" disabled={saving} onclick={onComplete}><Check size={16}/>{saving ? t("onboarding.saving") : t("onboarding.complete")}</button>
    </footer>
  </div>
</section>
