...
<style>
  ...
  @media(max-height:720px) and (min-width:701px){.onboarding-content{margin-bottom:12px}.welcome-steps{margin-top:10px}.welcome-steps li{padding:10px}.mode-choice{margin-top:7px}.mode-choice button{gap:3px;padding:9px 11px}.use-notice{margin-top:7px;padding:9px 12px}.use-notice p{line-height:15px}footer{margin-top:8px}}
