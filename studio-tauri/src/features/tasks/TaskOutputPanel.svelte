...
<style>
  ...
  .assessment{display:grid;gap:6px;margin-top:14px;padding:10px 11px;border:1px solid var(--rw-border);border-radius:7px;background:var(--rw-content);font-size:11px}.assessment.has-conflict{border-color:color-mix(in srgb,#c24848 55%,var(--rw-border));background:color-mix(in srgb,#c24848 5%,var(--rw-content))}.assessment>b{font-size:12px}.assessment.has-conflict>b{color:#c24848}.assessment-row{display:grid;grid-template-columns:72px minmax(0,1fr);gap:7px;align-items:start}.assessment-row strong{color:var(--rw-text)}.assessment-row span{display:block;line-height:15px}.approx{color:var(--rw-warning)}.conditional{color:var(--rw-text-secondary)}.conflict{color:#c24848}.dropped{color:var(--rw-muted)}.conflict-actions{display:flex;flex-wrap:wrap;gap:5px;margin:5px 0 7px}.conflict-actions button{padding:4px 7px;border:1px solid var(--rw-border);border-radius:5px;color:var(--rw-text-secondary);background:var(--rw-surface-raised);font-size:10px}.conflict-actions button:hover{color:var(--rw-accent);border-color:var(--rw-accent)}
