<script lang="ts">
  ...
  import type { ExportFormat, ExportPreservation, Inspection, UserMode } from "../../backend";
  ...
  import { featureDetailKeys } from "./feature-details";
