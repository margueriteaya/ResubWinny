...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            preview::clear_caption_overlay,
            preview::get_preview_time,
            preview::get_preview_duration,
            preview::get_preview_playback_state,
            preview::get_preview_broadcast_metadata,
            preview::get_playback_time_mapping,
            preview::update_playback_time_mapping,
            preview::render_at,
            preview::render_preview_at,
            preview::sync_preview_overlay,
