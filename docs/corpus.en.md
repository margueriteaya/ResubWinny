...
| `testdata/golden/b62-layout.xml` | Constructed ARIB-TTML semantic fixture | Stable JSON summary verifies nested timing, percentage regions, horizontal ruby evidence, vertical writing mode, font size, and colour without redistributing broadcast material. Unit regression also verifies that equivalent declared 1920×1080, 3840×2160, and 7680×4320 pixel layouts preserve their source planes and values while mapping to identical viewer-relative geometry and text lengths in the video-content viewport. |
