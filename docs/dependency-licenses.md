# Package-managed dependency licenses

This file is generated from the committed Cargo and npm lock data by
...
| `atk-sys` | `0.18.2` | MIT | Desktop service |
...
| `byteorder` | `1.5.0` | Unlicense OR MIT | Desktop service |
| `byteorder-lite` | `0.1.0` | Unlicense OR MIT | Worker |
...
| `gdk-sys` | `0.18.2` | MIT | Desktop service |
...
| `gio` | `0.18.4` | MIT | Desktop service |
| `gio-sys` | `0.18.1` | MIT | Desktop service |
| `glib` | `0.18.5` | MIT | Desktop service |
| `glib-macros` | `0.18.5` | MIT | Desktop service |
| `glib-sys` | `0.18.1` | MIT | Desktop service |
| `glob` | `0.3.4` | MIT OR Apache-2.0 | Desktop service |
| `gobject-sys` | `0.18.0` | MIT | Desktop service |
| `gtk` | `0.18.2` | MIT | Desktop service |
| `gtk-sys` | `0.18.2` | MIT | Desktop service |
| `gtk3-macros` | `0.18.2` | MIT | Desktop service |
| `hashbrown` | `0.12.3` | MIT OR Apache-2.0 | Desktop service |
| `hashbrown` | `0.15.5` | MIT OR Apache-2.0 | Desktop service |
| `hashbrown` | `0.17.1` | MIT OR Apache-2.0 | Desktop service |
...
| `num_enum_derive` | `0.7.6` | BSD-3-Clause OR MIT OR Apache-2.0 | Desktop service |
| `num-conv` | `0.2.2` | MIT OR Apache-2.0 | Desktop service |
| `num-traits` | `0.2.19` | MIT OR Apache-2.0 | Desktop service, Worker |
| `objc2` | `0.6.4` | MIT | Desktop service |
| `objc2-app-kit` | `0.3.2` | Zlib OR Apache-2.0 OR MIT | Desktop service |
| `objc2-cloud-kit` | `0.3.2` | Zlib OR Apache-2.0 OR MIT | Desktop service |
| `objc2-core-data` | `0.3.2` | Zlib OR Apache-2.0 OR MIT | Desktop service |
| `objc2-core-foundation` | `0.3.2` | Zlib OR Apache-2.0 OR MIT | Desktop service |
| `objc2-core-graphics` | `0.3.2` | Zlib OR Apache-2.0 OR MIT | Desktop service |
| `objc2-core-image` | `0.3.2` | Zlib OR Apache-2.0 OR MIT | Desktop service |
| `objc2-core-location` | `0.3.2` | Zlib OR Apache-2.0 OR MIT | Desktop service |
| `objc2-core-text` | `0.3.2` | Zlib OR Apache-2.0 OR MIT | Desktop service |
| `objc2-encode` | `4.1.0` | MIT | Desktop service |
| `objc2-exception-helper` | `0.1.1` | Zlib OR Apache-2.0 OR MIT | Desktop service |
| `objc2-foundation` | `0.3.2` | MIT | Desktop service |
| `objc2-io-surface` | `0.3.2` | Zlib OR Apache-2.0 OR MIT | Desktop service |
| `objc2-quartz-core` | `0.3.2` | Zlib OR Apache-2.0 OR MIT | Desktop service |
| `objc2-ui-kit` | `0.3.2` | Zlib OR Apache-2.0 OR MIT | Desktop service |
| `objc2-user-notifications` | `0.3.2` | Zlib OR Apache-2.0 OR MIT | Desktop service |
| `objc2-web-kit` | `0.3.2` | Zlib OR Apache-2.0 OR MIT | Desktop service |
| `once_cell` | `1.21.4` | MIT OR Apache-2.0 | Desktop service |
| `option-ext` | `0.2.0` | MPL-2.0 | Desktop service |
| `pango` | `0.18.3` | MIT | Desktop service |
| `pango-sys` | `0.18.0` | MIT | Desktop service |
| `parking_lot` | `0.12.5` | MIT OR Apache-2.0 | Desktop service |
| `parking_lot_core` | `0.9.12` | MIT OR Apache-2.0 | Desktop service |
| `percent-encoding` | `2.3.2` | MIT OR Apache-2.0 | Desktop service |
| `phf` | `0.13.1` | MIT | Desktop service |
| `phf_codegen` | `0.13.1` | MIT | Desktop service |
| `phf_generator` | `0.13.1` | MIT | Desktop service |
...
| `proc-macro-crate` | `2.0.2` | MIT OR Apache-2.0 | Desktop service |
| `proc-macro-crate` | `3.5.0` | MIT OR Apache-2.0 | Desktop service |
| `proc-macro-error` | `1.0.4` | MIT OR Apache-2.0 | Desktop service |
| `proc-macro-error-attr` | `1.0.4` | MIT OR Apache-2.0 | Desktop service |
| `proc-macro2` | `1.0.107` | MIT OR Apache-2.0 | Desktop service, Fuzz targets, Worker |
| `pxfm` | `0.1.30` | BSD-3-Clause OR Apache-2.0 | Worker |
| `quick-xml` | `0.41.0` | MIT | Desktop service |
| `quote` | `1.0.47` | MIT OR Apache-2.0 | Desktop service, Fuzz targets, Worker |
| `r-efi` | `5.3.0` | MIT OR Apache-2.0 OR LGPL-2.1-or-later | Desktop service |
| `r-efi` | `6.0.0` | MIT OR Apache-2.0 OR LGPL-2.1-or-later | Desktop service, Fuzz targets |
...
| `serde_derive` | `1.0.229` | MIT OR Apache-2.0 | Desktop service, Fuzz targets, Worker |
| `serde_derive_internals` | `0.29.1` | MIT OR Apache-2.0 | Desktop service |
| `serde_json` | `1.0.151` | MIT OR Apache-2.0 | Desktop service, Fuzz targets, Worker |
...
| `socket2` | `0.6.5` | MIT OR Apache-2.0 | Desktop service |
| `softbuffer` | `0.4.8` | MIT OR Apache-2.0 | Desktop service |
| `soup3` | `0.5.0` | MIT | Desktop service |
| `soup3-sys` | `0.5.0` | MIT | Desktop service |
| `stable_deref_trait` | `1.2.1` | MIT OR Apache-2.0 | Desktop service |
...
| `tower-layer` | `0.3.3` | MIT | Desktop service |
...
| `walkdir` | `2.5.0` | Unlicense/MIT | Desktop service |
...
| `windows_aarch64_msvc` | `0.42.2` | MIT OR Apache-2.0 | Desktop service |
| `windows_aarch64_msvc` | `0.52.6` | MIT OR Apache-2.0 | Desktop service |
| `windows_aarch64_msvc` | `0.53.1` | MIT OR Apache-2.0 | Desktop service |
| `windows_i686_gnu` | `0.42.2` | MIT OR Apache-2.0 | Desktop service |
| `windows_i686_gnu` | `0.52.6` | MIT OR Apache-2.0 | Desktop service |
| `windows_i686_gnu` | `0.53.1` | MIT OR Apache-2.0 | Desktop service |
| `windows_i686_gnullvm` | `0.52.6` | MIT OR Apache-2.0 | Desktop service |
| `windows_i686_gnullvm` | `0.53.1` | MIT OR Apache-2.0 | Desktop service |
| `windows_i686_msvc` | `0.42.2` | MIT OR Apache-2.0 | Desktop service |
| `windows_i686_msvc` | `0.52.6` | MIT OR Apache-2.0 | Desktop service |
| `windows_i686_msvc` | `0.53.1` | MIT OR Apache-2.0 | Desktop service |
| `windows_x86_64_gnu` | `0.42.2` | MIT OR Apache-2.0 | Desktop service |
| `windows_x86_64_gnu` | `0.52.6` | MIT OR Apache-2.0 | Desktop service |
| `windows_x86_64_gnu` | `0.53.1` | MIT OR Apache-2.0 | Desktop service |
| `windows_x86_64_gnullvm` | `0.42.2` | MIT OR Apache-2.0 | Desktop service |
| `windows_x86_64_gnullvm` | `0.52.6` | MIT OR Apache-2.0 | Desktop service |
| `windows_x86_64_gnullvm` | `0.53.1` | MIT OR Apache-2.0 | Desktop service |
...
| `windows-sys` | `0.60.2` | MIT OR Apache-2.0 | Desktop service |
| `windows-sys` | `0.61.2` | MIT OR Apache-2.0 | Desktop service |
